---
name: command-setup-fastapi
description: Initialise un projet FastAPI complet (venv, structure, bonnes pratiques). Utiliser pour demarrer un nouveau backend FastAPI.
---
