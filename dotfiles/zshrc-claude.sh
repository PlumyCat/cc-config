# =============================================================================
# Claude Code + Codex CLI - Configuration Zsh (macOS)
# Source: cc-config/dotfiles/zshrc-claude.sh
# Installation: ajouté automatiquement par install.sh --shell
#
# Convention :
...
# Zsh équivalent de huponexit: envoyer SIGHUP aux jobs en arrière-plan à la sortie
setopt HUP
